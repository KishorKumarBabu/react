...
<div className="max-w-4xl mx-auto mt-16 p-10 bg-gray-200 rounded-xl shadow-lg font-sans animate-fade-in">
  ...
  <section className="bg-white p-6 mb-6 rounded-lg border-l-4 border-red-200">
    ...
    <p className="text-gray-700">Delivering food with speed and responsibility using smart logistics and a human touch.</p>
  </section>
  ...
  <section className="bg-white p-6 my-6 rounded-lg border-l-4 border-red-200 shadow-sm">
    ...
    <ul className="list-disc pl-6 text-gray-700 space-y-2">
      <li><strong className="text-red-600">Customer First:</strong> Every decision is made keeping you in mind.</li>
      <li><strong className="text-red-600">Transparency:</strong> We believe in open pricing and honest delivery practices.</li>
      <li><strong className="text-red-600">Innovation:</strong> We constantly adapt and upgrade to serve you better.</li>
    </ul>
  </section>
